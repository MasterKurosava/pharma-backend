...
// reserveOnSet / writeOffOnSet / setAssemblyDateOnSet применяются ТОЛЬКО к STATE-статусам.
// Для ACTION-статусов эти флаги в seed принудительно false — их движок не читает.
const ACTION_STATUSES = [
  { code: 'ACTION_IN_STOCK', name: 'И.Есть', color: '#2563eb' },
  { code: 'ACTION_OUT_OF_STOCK', name: 'И.Нет', color: '#dc2626' },
  { code: 'ACTION_MOSCOW', name: 'И.Мос', color: '#7c3aed' },
  { code: 'ACTION_TURKEY', name: 'И.Тур', color: '#f59e0b' },
  { code: 'ACTION_TC', name: 'И.ТС', color: '#0ea5e9' },
  { code: 'ACTION_WAREHOUSE', name: 'И.Склад', color: '#0891b2' },
  { code: 'ACTION_INDIA', name: 'И.Индия', color: '#16a34a' },
  { code: 'ACTION_PLACE_ORDER', name: 'Оформите заказ', color: '#64748b' },
  { code: 'ACTION_ORDER_MOSCOW', name: 'Закажите Мос', color: '#7c3aed' },
  { code: 'ACTION_ORDER_TC', name: 'Закажите ТС', color: '#0ea5e9' },
  { code: 'ACTION_ORDER_TURKEY', name: 'Закажите Тур', color: '#f59e0b' },
  { code: 'ACTION_ORDER_INDIA', name: 'Закажите Инд', color: '#16a34a' },
  { code: 'ACTION_ORDER_WAREHOUSE', name: 'Закажите Склад', color: '#0891b2' },
  { code: 'ACTION_COLLECT_PICKUP', name: 'Соберите Самовывоз', color: '#2563eb' },
  { code: 'ACTION_SELECT_YANDEX', name: 'Выберите Яндекс', color: '#f59e0b' },
  { code: 'ACTION_CALLED_YANDEX', name: 'Вызвала Яндекс', color: '#d97706' },
  { code: 'ACTION_COLLECT_ALMATY', name: 'Соберите Алматы', color: '#0ea5e9' },
  { code: 'ACTION_COLLECT_PONY', name: 'Соберите Пони', color: '#8b5cf6' },
  { code: 'ACTION_COLLECT_DOVAS', name: 'Соберите ДоВас', color: '#2563eb' },
  { code: 'ACTION_COLLECT_INDRIVER', name: 'Соберите для Индрайвера', color: '#14b8a6' },
  { code: 'ACTION_RECEIVED_REPLY', name: 'Поступило ответьте', color: '#64748b' },
  { code: 'ACTION_NOTIFY_OTHER', name: 'Оповестите другое', color: '#64748b' },
] as const;
